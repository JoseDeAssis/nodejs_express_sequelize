...
router.get('/pessoas', (req, res) => pessoaController.getAll(req, res))
  ...
  .put('/pessoas/:id/cancela', (req, res) => pessoaController.cancelaRegistroEstudante(req, res))
  ...
  .get('/pessoas/:estudante_id/matriculas/confirmed', (req, res) => matriculaController.getMatriculasPorEstudante(req, res))
  .get('/pessoas/matriculas/lotadas', (req, res) => matriculaController.getCursosLotados(req, res))
